...
type ImageRepository interface {
	...
	UpdateImage(ctx context.Context, id int, image models.Image) (models.Image, error)
...
type ProcessingRepository interface {
	...
	UpdateProcessingJob(ctx context.Context, id int, job models.ProcessingJob) (models.ProcessingJob, error)
